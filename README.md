...
* [Графики, иллюстрирующие проведенные замеры](Результаты_графики.md)
    * _[код на питоне для создания графиков](python/p1)_
    * _[код на питоне для работы с таблицами](python/p2)_
* Выводы по результатам проведенного эмпирического анализа (прездставлены по ссылке выше)
